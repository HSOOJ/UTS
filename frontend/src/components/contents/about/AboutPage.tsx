          ...
          <Timeline mode="alternate">
            ...
            <Timeline.Item color="green">
              ...
              <TimeLineText isDark={isDark}>
                ...
                더불어 멋진 혜택까지 기다리고 있으니, 구매하지 않을 이유가
                없겠죠?🙆‍♀️🙆‍♂️
              </TimeLineText>
            </Timeline.Item>
            <Timeline.Item color="red">
              ...
              <TimeLineText isDark={isDark}>
                WALLET👝에 보관되어있는 당신의 뱃지를 확인해보세요. 프로필
                사진을 클릭하면, 나의 뱃지 컬렉션을 확인할 수 있습니다. 컬렉션에
                몇 개의 뱃지를 모을 수 있냐구요? 걱정마세요 😁, 제한이 없습니다!
              </TimeLineText>
            </Timeline.Item>
            <Timeline.Item>
              ...
              <TimeLineText isDark={isDark}>
                ...
                되팔아보세요. 뱃지를 판매하면 당신의 지갑이 다시 두둑해질거에요.
